...
import CaseIcon from "@/assets/icons/shared/case-icon.svg?react";
...
const subNavItems = [
  { to: "/case-management", icon: CaseIcon, label: "사건 관리" },
...
export default function Sidebar() {
  return (
    <aside className="flex h-screen w-20 shrink-0 flex-col overflow-hidden bg-white lg:w-64">
      ...
      <nav className="flex flex-1 flex-col items-center gap-4 px-2 lg:px-4">
