  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="rounded-xl border border-gray-200 bg-gray-50 p-3.5 text-xs leading-relaxed text-gray-500">
        이 문서는 참고용 초안입니다. 제출 전 호증 번호가 소장·준비서면에서 이미 낸 번호와 겹치지 않는지 반드시 확인하세요.
      </p>
