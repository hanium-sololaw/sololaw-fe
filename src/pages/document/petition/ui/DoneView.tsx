  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-3 rounded-2xl border border-gray-200 bg-white p-5">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2.5">
            <h1 className="text-xl font-bold text-gray-900">AI가 정리한 {doc.title}</h1>
          </div>
          <p className="mt-1 text-[13px] text-gray-500">입력한 내용을 신청서 양식에 맞춰 정리했습니다.</p>
        </div>
      ...
      <p className="rounded-xl border border-gray-200 bg-gray-50 p-3.5 text-xs leading-relaxed text-gray-500">
        이 문서는 참고용 초안입니다. 제출 전 당사자·금액·기재사항을 반드시 검토하고 수정하세요. 주민등록번호는 법원
        제출본에만 넣고 상대방 부본에서는 뒷자리를 가려주세요.
      </p>
