...
export default function CaseSearchHeader({
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <button
        type="button"
        className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700"
      >
        <DocumentIcon className="h-4 w-4" />내 인용 목록 {citationCount}
      </button>
    </div>
  );
}
