...
export default function AccuracyBanner() {
  ...
  if (accuracy === "낮음") {
    return (
      <div>
        <p className="flex items-center gap-1.5 rounded-xl bg-red-50 px-5 py-3 text-sm font-medium text-red-500">
  ...
  if (accuracy === "높음") {
    return (
      <p className="rounded-xl bg-blue-50 px-5 py-3 text-sm font-medium text-blue-500">
